        ...
        <div className="bg-slate-950 w-full">
          ...
          <div className="bg-[#ffff]">
            ...
            <div className="flex flex-row mx-28 mt-5">
              <div className="mr-20">
                <img className="w-full" src="/img/image2.png" alt="" />
              </div>
              <div className="mt-30">
                <a href="">
            ...
            <div className="flex flex-row justify-center mx-20 mt-20 ">
              <div className="py-5 px-4 bg-blue-100 rounded-lg">
                ...
                <img className="mt-3" src="/img/image3.png" alt="" />
              </div>
              <div className="py-5 px-4 bg-blue-100 rounded-lg ml-5">
                ...
                <img className="mt-3" src="/img/image4.png" alt="" />
              </div>
              <div className="py-5 px-4 bg-blue-100 rounded-lg ml-5">
                ...
                <img className="mt-3" src="/img/image5.png" alt="" />
              </div>
            </div>
            <div className="flex flex-row justify-center mx-20 mt-10 ">
              <div className="py-5 px-4 bg-blue-100 rounded-lg">
                ...
                <img className="mt-3" src="/img/image6.png" alt="" />
              </div>
              <div className="py-5 px-4 bg-blue-100 rounded-lg ml-5">
                ...
                <img className="mt-3" src="/img/image7.png" alt="" />
              </div>
              <div className="py-5 px-4 bg-blue-100 rounded-lg ml-5">
                ...
                <img className="mt-3" src="/img/image8.png" alt="" />
              </div>
            </div>
            ...
            <img className="mx-20 mt-20" src="/img/image9.png" alt="" />
