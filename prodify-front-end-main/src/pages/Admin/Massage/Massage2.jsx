                    ...
                    <div>
                      ...
                      <a href="">
                        <div className="flex flex-row mt-10">
                          <img className="mr-5" src="/img/gambar2.png" alt="" />
                          <div>
                            <p>Joleha</p>
                ...
                <main class="flex-grow bg-white-500">
                  <div className="flex flex-row mx-auto ml-5 mt-2">
                    <div className="flex flex-row mr-80">
                      <img className="w-50 h-50 mr-5" src="/img/gambar2.png" alt="" />
                      <div>
                        <p>Financy</p>
                        <p>6 Members</p>
                      </div>
                  ...
                  <div className="flex flex-row mt-10 ml-5">
                    <img className="w-10 h-10" src="/img/sarah.png" alt="" />
                  ...
                  <div className="flex flex-row mt-10 ml-5">
                    <img className="w-10 h-10" src="/img/alex.png" alt="" />
                    <div className="mt-2 ml-2">
                      <p>Alex</p>
                      <div className="mt-2 flex flex-row">
                        <p className="rounded-lg mr-5 bg-blue-100 px-2 py-2">
                  ...
                  <div className="flex flex-row justify-end mt-10 ml-5">
                    ...
                    <img className="w-10 h-10 mr-5" src="/img/saya.png" alt="" />
                  </div>
                  <div>
