            ...
            <section className="mb-7">
              <div className="flex flex-row mr-auto">
                ...
                <div className="flex flex-row ml-auto">
                  <img className="mt-2 w-28 h-8 mr-2" src={frame4} alt="" />
                ...
                <div className="h-200 rounded-lg p-6 mr-3 flex flex-row">
                    ...
                    <div className="h-60 border rounded-lg p-6 mr-3 mt-5 mb-5">
                      <div className="mb-4">
                        ...
                        <div className="flex flex-row mt-2">
                          <img className="h-5 w-9" src={frame} alt="" />
                    ...
                    <div className="h-45 border rounded-lg p-6 mr-3 mt-5">
                      <div className="mb-4">
                        ...
                        <div className="flex flex-row mt-3">
                          <img className="w-8 h-5" src={frame2} alt="" />
                          <div className="ml-auto">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="h-60 border rounded-lg p-6 mr-3 mt-5 mb-5">
                      ...
                      <hr />
                      <div className="flex flex-row mt-3">
                          <img className="w-20 h-5" src={frame4} alt="" />
                          <div className="ml-auto">
